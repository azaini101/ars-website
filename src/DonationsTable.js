...
const DonationsTable = ({ data }) => {
  ...
  return (
    <div>
      ...
      >
        <Button onClick={changeTableView}>Change View</Button>
        <Button onClick={() => setDataType(!dataType)}>
          Check {dataType ? "Register Dashboard" : "Idara Dashboard"}
        </Button>
        ...
        <Button onClick={() => exportExcel("all")}>Export All Data</Button>
      </Stack>
      <br></br>
      {tableView ? (
        <div>
